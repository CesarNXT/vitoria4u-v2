...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ref={ref}
    className={cn(
      "absolute right-2 top-2 rounded-md p-1 text-red-500 opacity-100 transition-all hover:text-red-600 hover:bg-red-50 focus:opacity-100 focus:outline-none focus:ring-2 focus:ring-red-400 group-[.destructive]:text-red-300 group-[.destructive]:hover:text-red-50 group-[.destructive]:hover:bg-red-600/20 group-[.destructive]:focus:ring-red-400",
      className
    )}
    toast-close=""
    {...props}
